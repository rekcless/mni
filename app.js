...
// ===== TOGGLE BULAN/TOTAL =====
modeMonth.onclick = () => { viewMode="month"; modeMonth.classList.add("active"); modeTotal.classList.remove("active"); renderUI(); };
modeTotal.onclick = () => { viewMode="total"; modeTotal.classList.add("active"); modeMonth.classList.remove("active"); renderUI(); };
...
// ===== FILTER BULAN =====
monthFilter.onchange = async()=>{currentMonth=monthFilter.value; await loadTarget(); renderUI();};
